...
namespace Medicuri.rptReportes.Inventarios {
    ...
    public class rptVentasPeriodo : ReportClass {
        
        public rptVentasPeriodo() {
        }
        
        public override string ResourceName {
            get {
                return "rptVentasPeriodo.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Medicuri.rptReportes.Inventarios.rptVentasPeriodo.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptVentasPeriodo : Component, ICachedReport {
        
        public CachedrptVentasPeriodo() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptVentasPeriodo rpt = new rptVentasPeriodo();
            rpt.Site = this.Site;
            return rpt;
        }
