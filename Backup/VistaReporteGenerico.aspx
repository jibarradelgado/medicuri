<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistaReporteGenerico.aspx.cs" Inherits="Medicuri.VistaReporteGenerico" %>
            ...
            <asp:Panel ID="pnlReporte" runat="server" GroupingText="Vista del reporte"  ScrollBars="auto">
                ...
                <ContentTemplate>
                    <CR:CrystalReportViewer ID="crvReporte" runat="server" AutoDataBind="true" 
                        ...
                        HasRefreshButton="False" HasToggleGroupTreeButton="True" onnavigate="crvReporte_Navigate" 
