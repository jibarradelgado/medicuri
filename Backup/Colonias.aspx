<%@ Page Title="" Language="C#" MasterPageFile="~/InterfazCatalogo.Master" AutoEventWireup="true" CodeBehind="Colonias.aspx.cs" Inherits="Medicuri.Colonias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolderBody" runat="server">
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="Colonias" HeaderText="Verifique los siguientes campos"/>
            ...
            <ContentTemplate>
                <div id="divCatalogoSeleccionable" >
                    ...
                    <ContentTemplate>
                        ...
                        <asp:ComboBox ID="cmbEstadoCatalogo" runat="server" MaxLength="0" 
                            ...
                            DataTextField="Nombre" DataValueField="idEstado" Width="110px">
                        </asp:ComboBox>                        
                        ...
                        <asp:ComboBox ID="cmbMunicipioCatalogo" runat="server" MaxLength="0" 
                            ...
                            DataTextField="Nombre" DataValueField="idMunicipio" Width="110px">
                        </asp:ComboBox>                        
                        <asp:Label ID="lblPoblacion2" runat="server" Text="Población:" Width="100px" CssClass="labelForms"></asp:Label>
                        <asp:ComboBox ID="cmbPoblacionCatalogo" runat="server" MaxLength="0" 
                            AppendDataBoundItems="True" AutoPostBack="true"                              
                            DataTextField="Nombre" DataValueField="idPoblacion" 
                            onselectedindexchanged="cmbPoblacionCatalogo_SelectedIndexChanged" 
                            Width="110px">
                        </asp:ComboBox>
                    </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div id="divCatalogoTabla">
                    ...
                    AutoGenerateColumns="False" 
                        EmptyDataText="No existen colonias registradas aun" 
    ...
    <div id="divFormulario" class="divFormulario">
        <asp:UpdatePanel ID="upnFormulario" runat="server">
            <ContentTemplate>
                ...
                <asp:TabPanel ID="tbpDatosColonia" runat="server" HeaderText="Datos de la Colonia">
                    <HeaderTemplate>
                        Datos de la Colonia
                    </HeaderTemplate>
                    <ContentTemplate>
                        <asp:Panel ID="pnlFormulario" runat="server" GroupingText="DatosGenerales">           
                ...
                <asp:UpdatePanel ID="pnlSeleccionable" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:ComboBox ID="cmbEstadoFormulario" runat="server" MaxLength="0" AutoPostBack="true"
                            ...
                            AppendDataBoundItems="True" Width="110px" DropDownStyle="DropDownList">
                        </asp:ComboBox>
                        ...
                        <asp:ComboBox ID="cmbMunicipioFormulario" runat="server" MaxLength="0" 
                            style="display: inline;" DataTextField="Nombre" AutoPostBack="true"
                            DataValueField="idMunicipio" AppendDataBoundItems="True" 
                            onselectedindexchanged="cmbMunicipioFormulario_SelectedIndexChanged" 
                            Width="110px" DropDownStyle="DropDownList" >
                        </asp:ComboBox>
                        <asp:Label ID="lblPoblacion" runat="server" CssClass="labelForms" 
                            Text="Población:" Width="90px"></asp:Label>
                        <asp:ComboBox ID="cmbPoblacionFormulario" runat="server" MaxLength="0" 
                            style="display: inline;"  
                            DataTextField="Nombre" DataValueField="idPoblacion" Width="110px" 
                ...
                <asp:UpdatePanel ID="pnlFormularioSub" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="txbClave" runat="server" CssClass="textBoxForms" 
                            ValidationGroup="Colonias" MaxLength="15" Width="130px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvClave" runat="server" ErrorMessage="Clave: campo requerido" 
                        ControlToValidate="txbClave" ValidationGroup="Colonias">*</asp:RequiredFieldValidator>
                        <asp:CustomValidator ID="cmvClave" runat="server" 
                            ErrorMessage="Clave: ya existe" Text="*" ValidationGroup="Colonias" 
                            onservervalidate="cmvClave_ServerValidate"></asp:CustomValidator>                                             
                        ...
                        <asp:TextBox ID="txbNombre" runat="server" CssClass="textBoxForms" 
                            ValidationGroup="Colonias" MaxLength="75" Width="130px"></asp:TextBox>
